...
# Import Numpy, Pandas, Geopandas & Matplotlib
...
# Using the Head function to view data
...
# This next step will involve merging the dataframes
...
# This data is the MPA data - not as high priority as being able to get functionality from the more granular data part of eda
...
# # Calculate the nearest distance for each wind farm from mpz 
